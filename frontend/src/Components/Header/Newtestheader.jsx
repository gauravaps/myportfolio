            ...
            <header className="header shadow sticky z-50 top-0">
                <nav className="nav bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                    <div className="nav-inner flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <Link to="/" className="logo-container flex items-center" onClick={() => setActiveLink("Home")}>
                            <img src={amazon} className="logo mr-3 h-14" alt="Logo" />
                        </Link>
                            ...
                            <ul className="menu-list flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                ...
                                <li className="menu-item">
                                    <NavLink
                                        to="/"
                                        className={({ isActive }) =>
                                            `menu-link block py-2 pr-4 pl-3 duration-200 ${isActive || activeLink === "Home" ? "text-orange-700" : "text-gray-700"} hover:text-orange-700 lg:p-0`
                                        }
                                ...
                                <li className="menu-item">
                                    <NavLink
                                        to="/about"
                                        className={({ isActive }) =>
                                            `menu-link block py-2 pr-4 pl-3 duration-200 ${isActive || activeLink === "About" ? "text-orange-700" : "text-gray-700"} hover:text-orange-700 lg:p-0`
                                        }
                                ...
                                <li className="menu-item">
                                    <NavLink
                                        to="/contact"
                                        className={({ isActive }) =>
                                            `menu-link block py-2 pr-4 pl-3 duration-200 ${isActive || activeLink === "Contact Us" ? "text-orange-700" : "text-gray-700"} hover:text-orange-700 lg:p-0`
                                        }
                                ...
                                >
                                    <button
                                        className="projects-button flex items-center py-2 pr-4 pl-3 hover:text-orange-700 focus:outline-none lg:p-0"
                                        onClick={() => {
                                ...
                                <li className="menu-item">
                                    <NavLink
                                        to="/course"
                                        className={({ isActive }) =>
                                            `menu-link block py-2 pr-4 pl-3 duration-200 ${isActive || activeLink === "course" ? "text-orange-700" : "text-gray-700"} hover:text-orange-700 lg:p-0`
                                        }
