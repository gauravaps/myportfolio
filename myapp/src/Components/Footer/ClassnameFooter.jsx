        ...
        <div className="footer-container mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="footer-links grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div className="footer-section">
                ...
                <ul className="footer-section-list text-grey-600 font-medium">
                  ...
                  <li>
                    <Link to="/about" className="footer-link hover:underline">Our Courses</Link>
                  </li>
                </ul>
              </div>
              <div className="footer-section">
                ...
                <ul className="footer-section-list text-gray-500 font-medium">
                  ...
                  <li>
                    <Link to="/" className="footer-link hover:underline">Discord</Link>
                  </li>
                </ul>
              </div>
              <div className="footer-section">
                ...
                <ul className="footer-section-list text-gray-500 font-medium">
                  ...
                  <li>
                    <Link to="#" className="footer-link hover:underline">Terms &amp; Conditions</Link>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <hr className="footer-divider my-6 border-gray-200 sm:mx-auto lg:my-8" />
          <div className="footer-bottom sm:flex sm:items-center sm:justify-between">
            <span className="footer-copy text-sm text-gray-500 sm:text-center">
              © 2023
              <a href="https://github.com/gauravaps" className="footer-link hover:underline">gauravgitHub.com</a>
              . All Rights Reserved.
            </span>
            <div className="footer-social flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              <Link to="#" className="footer-social-link text-gray-500 hover:text-gray-900">
                <svg
